...
function Coin(data){
    ...
    this.generateScratchpad = function(seed, height){
        return zanoUtil.generate_scratchpad(new Buffer(seed, 'hex'), height);
    };
    ...
    this.BlockTemplate = function(template) {
        ...
        // Set this.seed to the scratchpad seed.
    ...
    this.cryptoNight = function(convertedBlob) {
        // return zanoUtil.get_pow_hash(convertedBlob, this.scratchpad, this.height);
        return zanoUtil.get_id_hash(convertedBlob);
    };
}
